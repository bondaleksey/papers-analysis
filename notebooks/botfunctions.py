...
class BotMenu():
    ...
    def get_undermenu_reply(self):
        text = ['Введите ключевые слова для поиска. Например: "Суперкомпьютерное моделирование","MPI","openMP", "GPU", "параллельной алгоритмы", "системы дифференциальных уравнений"',
